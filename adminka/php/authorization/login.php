    ...
    <div class="authentication-wrapper">
        <div class="authentication-header">
            ...
            <div class="authentication-block">
                <div class="authentication-header__title">Нет доступа?</div>
                <a href="/index.php" class="authentication-link__login"><i class="fa-solid fa-arrow-right-to-bracket"></i>На главную</a>
            </div>
        </div>
            ...
            <fieldset>
                ...
                if (isset($_POST['btnLogin'])) {
                    ...
                    if ($_POST['userLogin'] and $_POST['userPassword'] != '') {
                        foreach ($users as $n) {
                            if (($n['Login'] == $Login) and ($n['Password'] == $Password) and ($n['Role'] == 'admin' || $n['Role'] == 'editor')) {
